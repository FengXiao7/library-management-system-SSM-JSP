...
<div class="row">
    <div class="col-md-6 column">
        <a id="add" class="btn btn-primary" href="${pageContext.request.contextPath}/administrator/toAddManager">新增管理员</a>
            ...
            <c:forEach var="manager" items="${ManagerList}">
                <tr>
                    ...
                    <td>
                        ...
                        <a class="modify" href="${pageContext.request.contextPath}/administrator/toUpdate/${manager.getManagerID()}">修改</a>&nbsp;|&nbsp;
                        <a class="delete" href="${pageContext.request.contextPath}/administrator/delete/${manager.getManagerID()}">删除</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
