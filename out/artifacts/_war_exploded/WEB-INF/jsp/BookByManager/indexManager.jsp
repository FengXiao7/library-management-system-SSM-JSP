        ...
        <div class="panel-group Menu_list" id="box">
            ...
            <div class="panel panel-info Menu_list">
                ...
                <div class="panel-collapse collapse" id="collapseA">
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="${pageContext.request.contextPath}/manager/allUser" target="iframe_cont">
                                <span class="glyphicon glyphicon-user">用户列表</span></a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/manager/ViewUserOverBorrowingTime " target="iframe_cont"><span
                                    class="glyphicon glyphicon-user"> </span> 借阅逾期用户</a></li>
                            <li><a href="${pageContext.request.contextPath}/manager/allManager" target="iframe_cont">
...
<%--                            偷了个懒，用一张表存起来更好！不然每次新增新类别的书籍，就要手动加一个a标签--%>
                            <li><a href="${pageContext.request.contextPath}/manager/queryBookType/小说" target="iframe_cont"><span
                                    class="glyphicon glyphicon-align-left"> </span>小说</a></li>
                            <li><a href="${pageContext.request.contextPath}/manager/queryBookType/漫画" target="iframe_cont">
                                <span class="glyphicon glyphicon-align-left"> </span> 漫画</a></li>
                            <li><a href="${pageContext.request.contextPath}/manager/queryBookType/科幻" target="iframe_cont"><span
                                    class="glyphicon glyphicon-align-left"> </span>科幻</a></li>
                            <li><a href="${pageContext.request.contextPath}/manager/queryBookType/文学" target="iframe_cont"><span
                                    class="glyphicon glyphicon-align-left"> </span>文学</a></li>
                            <li><a href="${pageContext.request.contextPath}/manager/queryBookType/知识" target="iframe_cont">
                                <span class="glyphicon glyphicon-align-left"> </span> 知识</a></li>
                            <li><a href="${pageContext.request.contextPath}/manager/queryBookType/历史" target="iframe_cont">
