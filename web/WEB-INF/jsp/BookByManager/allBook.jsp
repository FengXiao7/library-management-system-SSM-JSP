            ...
            <table class="table table-hover table-striped">
                ...
                <c:forEach var="book" items="${applicationScope.BookList}">
                    <tr>
                        ...
                        <td>
                            <a href=" ${pageContext.request.contextPath}/administrator/AllBorrowByBookID/${book.getBookID()}">借阅情况</a>&nbsp;|&nbsp;
                            <a href=" ${pageContext.request.contextPath}/administrator/AllCommentByBookID/${book.getBookID()}">评论情况</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
