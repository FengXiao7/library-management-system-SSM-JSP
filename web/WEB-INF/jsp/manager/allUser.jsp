...
<div class="row">
    ...
    <form action="${pageContext.request.contextPath}/administrator/queryUser" method="post" class="form-inline">
        ...
        <table class="table table-hover table-striped">
            ...
            <c:forEach var="user" items="${applicationScope.allUser}">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/administrator/AllBorrowByUserID/${user.getUserID()}">借阅情况</a>&nbsp;|&nbsp;
                        <a href="${pageContext.request.contextPath}/administrator/AllCommentByUserID/${user.getUserID()}">评论情况</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
